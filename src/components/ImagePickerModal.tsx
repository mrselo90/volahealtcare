            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 text-sm text-professional transition-colors ${
                    activeTab === tab.id
          ...
          <div className="p-6 max-h-[60vh] overflow-y-auto">
            {activeTab === 'gallery' && (
              <div className="space-y-4">
                ...
                {/* Gallery Grid */}
                <div className="space-y-3">
                  <h3 className="text-sm text-professional text-gray-700">Medical Stock Images</h3>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
