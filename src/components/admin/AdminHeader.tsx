        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-primary">Vola Health Admin</span>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            {/* Language Selector - Admin Panel is English Only */}
            <div className="flex items-center text-gray-600">
              <RiGlobalLine className="h-5 w-5" />
              <span className="ml-2 text-sm font-medium">Admin Panel (English)</span>
            </div>
