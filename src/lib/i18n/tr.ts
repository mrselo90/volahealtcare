...
export const trTranslations: Translations = {
  ...
  services: {
    ...
    duration: 'Süre',
    featuredOnly: 'Sadece Öne Çıkan Hizmetler',
    anyDuration: 'Herhangi Bir Süre',
    oneTwoHours: '1-2 Saat',
    halfDay: 'Yarım Gün',
    fullDay: 'Tam Gün',
    multipleDays: 'Çoklu Günler',
  ...
  consultation: {
    ...
    benefits: {
      ...
      time: {
        title: '15 Dakika',
        description: 'Kapsamlı değerlendirme ve kişiselleştirilmiş tedavi planı'
      },
      expert: {
        title: 'Uzman Bakım',
