          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-500">
                <p>{t('consultation.success.questions') || 'Questions? Message us'} 💬 <a href={`https://wa.me/${settings.contactPhone.replace(/[^\d]/g, '')}`} target="_blank" rel="noopener noreferrer" className="font-semibold text-green-600 hover:text-green-700">{settings.contactPhone}</a></p>
              </div>
            </div>
          </motion.div>
        </div>
